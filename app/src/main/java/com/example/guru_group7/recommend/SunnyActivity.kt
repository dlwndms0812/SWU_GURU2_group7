...
class SunnyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imgBtn_music.setOnClickListener {
            var intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=HGrP1qdE5Rw"))
            startActivity(intent)
        }

        imgBtn_hobby.setOnClickListener {
            var intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=7abU7ry8Ikg"))
            startActivity(intent)
        }
